define("7ea822f8-22ef-44e4-a8b1-ca843fd608b2_0.0.1", ["@microsoft/sp-core-library","@microsoft/sp-webpart-base","@microsoft/sp-property-pane","jquery","ProjectHomeTilesWebPartStrings"], function(__WEBPACK_EXTERNAL_MODULE_46__, __WEBPACK_EXTERNAL_MODULE_47__, __WEBPACK_EXTERNAL_MODULE_48__, __WEBPACK_EXTERNAL_MODULE_49__, __WEBPACK_EXTERNAL_MODULE_83__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return readItems; });
/* unused harmony export readItem */
...
/* unused harmony export DeleteFolder */
/* unused harmony export GetFolder */
/* unused harmony export formString */
/* unused harmony export additemsattachment */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return checkUserinGroup; });
/* unused harmony export batchDelete */
/* unused harmony export formatDate */
/* unused harmony export GetQueryStringParams */
...
function additemsimage(listName, filename, file, listColumns) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.getFolderByServerRelativeUrl(listName).files.add(filename, file, true)
                        .then(function (result) {
                        result.file.listItemAllFields.get().then(function (listItemAllFields) {
                            return __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.lists.getByTitle(listName).items.getById(listItemAllFields.Id).update(listColumns);
                        });
                    })];
                case 1:
                    result = _a.sent();
...
function DeleteFolder(listName, folderName) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js___default.a.sp.web.folders.getByName(listName).folders.getByName(folderName).delete()];
                case 1: return [2 /*return*/, _a.sent()];
            }
        });
    });
...
function getListOfSubSites(url) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    my_web = new __WEBPACK_IMPORTED_MODULE_0_sp_pnp_js__["Web"](url);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__microsoft_sp_property_pane__ = __webpack_require__(48);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ProjectHomeTilesWebPartStrings__ = __webpack_require__(83);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ProjectHomeTilesWebPartStrings___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_ProjectHomeTilesWebPartStrings__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery__ = __webpack_require__(49);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_jquery___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_jquery__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__commonJS__ = __webpack_require__(50);
var __extends = (this && this.__extends) || (function () {
    var extendStatics = Object.setPrototypeOf ||
        ({ __proto__: [] } instanceof Array && function (d, b) { d.__proto__ = b; }) ||
        function (d, b) { for (var p in b) if (b.hasOwnProperty(p)) d[p] = b[p]; };
...
var ProjectHomeTilesWebPart = /** @class */ (function (_super) {
    ...
    ProjectHomeTilesWebPart.prototype.render = function () {
        ...
        var ModalHTML = '<div class="modal fade" id="Addmodal" tabindex="-1" role="dialog" aria-labelledby="basicModal" aria-hidden="true">' +
            ...
            '</div>' +
            '</div>';
        __WEBPACK_IMPORTED_MODULE_4_jquery__("body").after(ModalHTML);
        var siteurl = this.context.pageContext.site.absoluteUrl;
        this.FetchItems();
        var Addevent = __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnAddSubmit');
        Addevent.on("click", function (e) { return _this.AddNewTile(); });
        var EditEvent = __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnEditSubmit');
        EditEvent.on("click", function (e) { return _this.UpdateItem(); });
        var DeleteEvent = __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnDelete');
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["d" /* readItems */])(listName, columnArray, 10, "ID", "Username", Username)];
                    case 1:
                        ...
                        __WEBPACK_IMPORTED_MODULE_4_jquery__('.gallery-section').append(HTML);
                        __WEBPACK_IMPORTED_MODULE_4_jquery__('.TileEdit').click(function (event) {
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#myModalLabel').text("EDIT FAVOURITES");
                            var TileID = __WEBPACK_IMPORTED_MODULE_4_jquery__(this).attr("id");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnAddSubmit').hide();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnEditSubmit').show();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnDelete').show();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val("");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val("");
                            var GetListItems = Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["d" /* readItems */])(listName, columnArray, 10, "Modified", "ID", parseInt(TileID));
                            GetListItems.then(function (result) {
                                __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtID').val(result[0].ID);
                                __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val(result[0].Title);
                                __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val(result[0].LinkURL.Url);
                            });
                        });
                        __WEBPACK_IMPORTED_MODULE_4_jquery__('.icon-remove').click(function (event) {
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val("");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val("");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnAddSubmit').show();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnEditSubmit').hide();
                        });
                        __WEBPACK_IMPORTED_MODULE_4_jquery__('.AddTile').click(function (event) {
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#myModalLabel').text("ADD NEW FAVOURITES");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val("");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val("");
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnAddSubmit').show();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnEditSubmit').hide();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#Addmodal').show();
                            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnDelete').hide();
                        });
                        return [2 /*return*/];
                }
            });
    ...
    ProjectHomeTilesWebPart.prototype.AddNewTile = function () {
        if (__WEBPACK_IMPORTED_MODULE_4_jquery__('.ajs-message').length > 0) {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('.ajs-message').remove();
        }
        if (this.Validation()) {
            __WEBPACK_IMPORTED_MODULE_4_jquery__('#btnAddSubmit').hide();
            __WEBPACK_IMPORTED_MODULE_4_jquery__('#lblwait').show();
            var listName = "Tiles";
            var itemObj = {
                Title: __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val(),
                Username: this.context.pageContext.user.displayName,
                LinkURL: {
                    "__metadata": {
                        "type": "SP.FieldUrlValue"
                    },
                    Url: __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val()
                }
            };
            Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["a" /* addItems */])(listName, itemObj).then(function (result) {
                location.reload();
            });
        }
    };
    ProjectHomeTilesWebPart.prototype.UpdateItem = function () {
        ...
        if (this.Validation()) {
            ...
            var itemId = +__WEBPACK_IMPORTED_MODULE_4_jquery__('#txtID').val();
            var itemObj = {
                Title: __WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val(),
                Username: this.context.pageContext.user.displayName,
                LinkURL: {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["e" /* updateItem */])(listName, itemId, itemObj).then(function (result) {
                location.reload();
            });
        }
    };
    ProjectHomeTilesWebPart.prototype.DeleteItem = function () {
        ...
        alertify.confirm('Confirmation', strconfirm, function () {
            var listName = "Tiles";
            var itemId = +__WEBPACK_IMPORTED_MODULE_4_jquery__('#txtID').val();
            Object(__WEBPACK_IMPORTED_MODULE_5__commonJS__["c" /* deleteItem */])(listName, itemId).then(function (result) {
                location.reload();
            });
        }, function () {
        }).set('closable', false);
    ...
    ProjectHomeTilesWebPart.prototype.Validation = function () {
        ...
        if (!__WEBPACK_IMPORTED_MODULE_4_jquery__('#txtTitle').val()) {
            alertify.set('notifier', 'position', 'top-right');
            alertify.error("Please Enter the Title");
            return false;
        }
        else if (!__WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val()) {
            alertify.set('notifier', 'position', 'top-right');
            alertify.error("Please Enter the URL");
            return false;
        }
        else if (!regexp.test(__WEBPACK_IMPORTED_MODULE_4_jquery__('#txtLinkUrl').val().toString().trim())) {
            //$('#txtHyper').focus();
            alertify.set('notifier', 'position', 'top-right');
    ...
    ProjectHomeTilesWebPart.prototype.getPropertyPaneConfiguration = function () {
        return {
            pages: [
                {
                    header: {
                        description: __WEBPACK_IMPORTED_MODULE_3_ProjectHomeTilesWebPartStrings__["PropertyPaneDescription"]
                    },
                    groups: [
                        {
                            groupName: __WEBPACK_IMPORTED_MODULE_3_ProjectHomeTilesWebPartStrings__["BasicGroupName"],
                            groupFields: [
                                Object(__WEBPACK_IMPORTED_MODULE_2__microsoft_sp_property_pane__["PropertyPaneTextField"])('description', {
                                    label: __WEBPACK_IMPORTED_MODULE_3_ProjectHomeTilesWebPartStrings__["DescriptionFieldLabel"]
                                })
                            ]
                        }
                    ]
...
/* harmony default export */ __webpack_exports__["default"] = (ProjectHomeTilesWebPart);
...
/***/ })
/******/ ])});;
//# sourceMappingURL=project-home-tiles-web-part.js.map